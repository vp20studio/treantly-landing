          ...
          <div className="space-y-6">
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
              <a
                ...
                className="btn-primary text-[var(--brand-cream)] px-6 py-3 rounded-xl font-semibold text-base inline-flex items-center gap-2 group"
              >
                Get Started
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-2 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              ...
              <div>
                ...
                <div className="flex items-center gap-1 text-xs sm:text-sm text-[var(--muted)]">
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[var(--brand-teal)]" fill="currentColor" viewBox="0 0 20 20">

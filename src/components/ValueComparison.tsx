export default function ValueComparison() {
  ...
  return (
    <section id="pricing" className="relative py-24 px-6 lg:px-8 bg-[var(--brand-beige)] overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-elevated border border-[var(--error)]/10 relative overflow-hidden hover-lift">
          ...
          {/* Treantly Card */}
          <div className="relative bg-gradient-to-br from-[var(--brand-green)] to-[#1f3326] rounded-3xl p-8 shadow-elevated overflow-hidden hover-lift hover-glow">
